...
export default {
  ...
  computed: {
    ...
    columns() {
      return [
        ...
        { prop: "tkThueDauVao", label: "TK Thuế đầu vào", minWidth: "110px" },
        {
          prop: "hoaDonDt",
          label: "Hóa đơn ĐT",
          minWidth: "100px",
        ...
        {
          prop: "hangHoaChiuThue",
          label: "Hàng hóa chịu thuế",
          minWidth: "250px",
          align: "left",
          type: "combobox",
          combodata: this.comboboxDataHangHoa,
        },
        {
          prop: "maSoThue",
          label: "Mã số thuế",
  ...
  methods: {
    ...mapActions("nhapchungtu", [
      "setRowFlag",
      "updateHoaDonMuaVaoCell",
      "loadDmThueSuatMuaVao",
    ]),
    handleRow(type, row) {
      console.log("handle", type, row);
      this.setRowFlag({
        stateName: "hoaDonMuaVaoData",
        key: "id",
        value: row.id,
        flagName: type,
        row: row,
