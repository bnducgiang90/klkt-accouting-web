...
export default {
  ...
  methods: {
    initForm() {
      if (this.isEdit && this.customerData) {
        this.form = {
          ...this.customerData,
          khach_hang: Boolean(this.customerData.khach_hang),
          nha_cungcap: Boolean(this.customerData.nha_cungcap),
          du_no: this.customerData.du_no || 0,
          du_co: this.customerData.du_co || 0,
          cap: this.customerData.cap || 1
        };
      } else {
        this.resetForm();
      }
